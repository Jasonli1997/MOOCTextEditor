...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			// Time a loop that runs trials times for BasicDocument
			long startTime = System.nanoTime();
			BasicDocument bd = new BasicDocument(stringFile);
			double basicFlesh = bd.getFleschScore();
			long endTime = System.nanoTime();
			double bdTime = (endTime - startTime) / 100000000.0;
			System.out.print(bdTime + "\t");
			
			// Time a loop that runs trials times for EfficientDocument 
			long startETime = System.nanoTime();
			EfficientDocument ed = new EfficientDocument(stringFile);
			double EfficientFlesh = ed.getFleschScore();
			long endETime = System.nanoTime();
			double edTime = (endETime - startETime) / 100000000.0;
